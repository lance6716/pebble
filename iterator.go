...
import (
	...
	"github.com/lance6716/pebble/internal/fastrand"
...
// https://github.com/lance6716/pebble/issues/29#issuecomment-494477985
	...
	if len(mi.levels) > 1 {
		mi.ForEachLevelIter(func(li *levelIter) bool {
			...
			if f := li.iterFile; f != nil {
				...
				// at:
				// https://github.com/lance6716/pebble/pull/1041#issuecomment-763226492
				if containsKey {
